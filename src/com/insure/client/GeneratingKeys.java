...
public class GeneratingKeys {
    ...
    public GeneratingKeys(KeyPairGenerator keyGen, KeyPair pair, PrivateKey privateKey, PublicKey publicKey) {
        this.keyGen = keyGen;
        this.pair = pair;
        this.privateKey = privateKey;
        this.publicKey = publicKey;
    ...
    public GeneratingKeys(int keyLength) throws NoSuchAlgorithmException{
